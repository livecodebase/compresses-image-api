...
const compressImage = async ({
  ...
  // console.log(`🔍 Brightness: ${stats.avgBrightness.toFixed(2)}, Saturation: ${stats.avgSaturation.toFixed(2)}`);
  // console.log('Auto quality: ', autoQuality);

  // const recommendedQuality = await getAutoJPEGQuality(filepath);
  // console.log('Recommended Quality: ', recommendedQuality);

  // stats.avgBrightness > 60 ?
  // let optimalQuantity =  Math.min(autoQuality, recommendedQuality)

  // if (filesize > 2 * 1024 * 1024) { // If file size is greater than 2MB
  //   optimalQuantity = recommendedQuality;
  // }else if (filesize < 0.2 * 1024 * 1024) { // If file size is greater than 2MB
  //   optimalQuantity = autoQuality;
  // }

  // console.log('optimalQuantity: ', optimalQuantity);
  // console.log("----------------");
  // let minifiedImage;
